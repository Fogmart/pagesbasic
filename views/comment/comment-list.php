                    ...
                    <div class="actions">
                        ...
                        if (!$Comment->isDeleted()) {
                            if ($Comment->canCreate()) {
                                echo Html::a(FA::icon('reply') . ' ' . Yii::t('app', 'Ответ'), '#', [
                            ...
                            if ($Comment->canUpdate()) {
                                echo Html::a(
                                    FA::icon('pencil') . ' ' . Yii::t('app', 'изменить'),
                                    '#',
                                    [
                                        'data-role' => 'edit',
                            ...
                            if ($Comment->canDelete()) {
                                 echo Html::a(
                                    FA::icon('times') . ' ' . Yii::t('app', 'удалить'),
...
if ($CommentListWidget->showCreateForm && $CommentModel::canCreate()) {
    echo Html::tag('h3', Yii::t('app', 'Комментировать'), ['class' => 'comment-title']);
